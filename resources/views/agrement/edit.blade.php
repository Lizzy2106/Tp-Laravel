<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="post" action="{{ route('agrement.update' , $agrement->id) }}">@csrf
				@method('PUT')
				<!-- Car inf -->
								...
								<div class="px-4 py-5 bg-white sm:p-6">
									 	<div class="grid grid-cols-4 gap-4 mt-4">
											<div class="col-span-6 sm:col-span-6 lg:col-span-2">
												...
												<input type="text" name="titre" id="titre" autocomplete="given-name"  value="{{old('titre', $agrement->titre)}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('titre')) is-invalid @endif" placeholder="Titre de mon agrément">
												@if($errors->has('titre'))
											...
											<div class="col-span-6 sm:col-span-6 lg:col-span-2">
												...
												<input type="text" name="option1" id="option1" autocomplete="given-name"  value="{{old('option1', $agrement->option1)}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('option1')) is-invalid @endif" placeholder="Ceci est une option">
									 	...
									 	<div class="grid grid-cols-4 gap-4 mt-4">
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option2" id="option2" autocomplete="given-name"  value="{{old('option2', $agrement->option2)}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('option2')) is-invalid @endif" placeholder="Titre de mon agrément">
										  ...
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option3" id="option3" autocomplete="given-name"  value="{{old('option3', $agrement->option3)}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('option3')) is-invalid @endif" placeholder="Ceci est une option">
									 	...
									 	<div class="grid grid-cols-4 gap-4 mt-4">
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option4" id="option4" autocomplete="given-name"  value="{{old('option4', $agrement->option4)}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('option4')) is-invalid @endif" placeholder="Titre de mon agrément">
										  ...
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option5" id="option5" autocomplete="given-name" value="{{old('option5', $agrement->option5)}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @if($errors->has('option5')) is-invalid @endif" placeholder="Ceci est une option">
