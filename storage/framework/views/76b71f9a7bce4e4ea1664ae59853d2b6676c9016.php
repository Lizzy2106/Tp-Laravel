      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="block mb-8">
              ...
              <div class="block mb-8" style="margin-top: 10px;">
                  <a href="<?php echo e(route('agrement.create')); ?>" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Ajouter un agrement</a>
              </div>
          </div>
          <br />
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      <?php else: ?>
                        <?php $__currentLoopData = $agrements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agrement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                              <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                  <?php echo e($agrement->titre); ?>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                           <?php echo e($agrement->option1); ?>

                          </td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                           <?php echo e($agrement->option2); ?>

                          </td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                           <?php echo e($agrement->option3); ?>

                          </td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                           <?php echo e($agrement->option4); ?>

                          </td>
                          <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                           <?php echo e($agrement->option5); ?>

                          </td>

                          <td>
                            <a href="<?php echo e(route('agrement.edit', $agrement->id)); ?>" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2 table-update">Modifier</a>
                            <a style="cursor: pointer;" id="<?php echo e($agrement->id); ?>" class="text-red-600 hover:text-red-900 mb-2 mr-2 table-delete">Supprimer</a>
                          </td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH /var/www/html/Laravel/carrental/resources/views/agrement/index.blade.php ENDPATH**/ ?>