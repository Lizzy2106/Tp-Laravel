...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header'); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Liste des agréments')); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="post" action="<?php echo e(route('agrement.store')); ?>"><?php echo csrf_field(); ?>
								...
								<div class="px-4 py-5 bg-white sm:p-6">
									 	<div class="grid grid-cols-4 gap-4 mt-4">
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="titre" id="titre" autocomplete="given-name"  value="<?php echo e(old('titre')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('titre')): ?> is-invalid <?php endif; ?>" placeholder="Titre de mon agrément">
										  ...
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option1" id="option1" autocomplete="given-name"  value="<?php echo e(old('option1')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('option1')): ?> is-invalid <?php endif; ?>" placeholder="Ceci est une option">
									 	...
									 	<div class="grid grid-cols-4 gap-4 mt-4">
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option2" id="option2" autocomplete="given-name"  value="<?php echo e(old('option2')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('option2')): ?> is-invalid <?php endif; ?>" placeholder="Titre de mon agrément">
										  ...
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option3" id="option3" autocomplete="given-name"  value="<?php echo e(old('option3')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('option3')): ?> is-invalid <?php endif; ?>" placeholder="Ceci est une option">
									 	...
									 	<div class="grid grid-cols-4 gap-4 mt-4">
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option4" id="option4" autocomplete="given-name"  value="<?php echo e(old('option4')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('option4')): ?> is-invalid <?php endif; ?>" placeholder="Titre de mon agrément">
										  ...
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="text" name="option5" id="option5" autocomplete="given-name"  value="<?php echo e(old('option5')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('option5')): ?> is-invalid <?php endif; ?>" placeholder="Ceci est une option">
...
<?php endif; ?>
<?php /**PATH /var/www/html/Laravel/carrental/resources/views/agrement/create.blade.php ENDPATH**/ ?>