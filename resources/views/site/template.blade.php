            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="{{ route('home') }}" class="nav-link">Acceuil</a></li>
                  <!-- <li><a href="{{ route('voiture.index') }}" class="nav-link">Cars</a></li> -->
                  <li><a href="{{ route('voiture.index') }}" class="nav-link">Voitures</a></li>
                  ...
                  <li class="dropdup show">
                  	<a class="nav-link dropdown-toggle"  href="#" role="button" id="user" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">            
	                  	...
	                  	<div class="dropdown-menu" aria-labelledby="user">
							...
							<a class="dropdown-item" href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')">{{ __('Profile') }}</a>
