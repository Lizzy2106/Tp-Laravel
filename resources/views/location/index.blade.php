    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="block mb-8">
              <a href="{{ route('location.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Ajouter une location</a>
          </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      @else
                        ...
                        <tr>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{$location->voiture->titre}}</div>
                            <div class="text-sm text-gray-500">{{$location->voiture->marque}}</div>
                          </td>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route('location.show', $location->id) }}" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">Voir</a>
                            <a href="{{ route('location.edit', $location->id) }}" class="text-indigo-600 hover:text-indigo-900 mb-2 mr-2 table-update">Modifier</a>
                            <a style="cursor: pointer;" id="{{$location->id}}" class="text-red-600 hover:text-red-900 mb-2 mr-2 table-delete">Supprimer</a>
                          </td>
                        </tr>
                        @endforeach
                      @endif
