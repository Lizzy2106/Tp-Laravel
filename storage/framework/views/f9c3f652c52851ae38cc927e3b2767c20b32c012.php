...
<?php $component->withAttributes([]); ?>
		 <?php $__env->slot('header'); ?> 
				<h2 class="font-semibold text-xl text-gray-800 leading-tight">
						<?php echo e(__('Ajouter une location')); ?>
										...
										<div class="col-span-6 sm:col-span-6 lg:col-span-2">
									 	...
									 	<div class="grid grid-cols-4 gap-4 mt-4">
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="datetime-local" name="from" id="from" autocomplete="given-name"  value="<?php echo e(old('from')); ?>" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('from')): ?> is-invalid <?php endif; ?>" placeholder="2017-06-01T08:30">
										  ...
										  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
											...
											<input type="datetime-local" name="to" id="to" autocomplete="family-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php if($errors->has('to')): ?> is-invalid <?php endif; ?>" value="<?php echo e(old('to')); ?>" placeholder="2017-06-02T08:30">
...
<?php endif; ?>
<?php /**PATH /var/www/html/Laravel/carrental/resources/views/location/create.blade.php ENDPATH**/ ?>